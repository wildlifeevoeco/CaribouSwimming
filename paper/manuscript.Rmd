...
31) and we identified `r nids` adult female caribou that collectively had `r
nevents` swimming events over three years (Figure 2). In addition to our own
...
introduction of caribou in the 1960s. More likely, however, it is fine-scale
competition for foraging resources that drives caribou to swim to new islands.
...
events, suggesting that for ~10% of collared individuals swimming is relatively
