...
for approximately `r dur` (range = `r durMin`-`r durMax`) days before swimming again. Caribou may swim between
islands in the ocean for similar reasons they swim in freshwater [@Leblond2016].
We propose that one such explanation, the forage limitation hypothesis, is a
likely explanation for oceanic swimming for caribou that live on islands in the
...
archipelago. Only `r n10` of these 12 individuals had more than 10 swimming
