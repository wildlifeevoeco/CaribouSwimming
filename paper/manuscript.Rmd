...
Canada). We identified swimming events as two consecutive GPS locations (2-hour
...
restricted our GPS data to the ice-free period of the year (April 1 - December
31) and we identified `r nids` adult female caribou that collectively had `r nevents` 
swimming events over three years (Figure 2). In addition to our own
visual and remotely sensed observations, residents of Fogo Island have also
reported observing caribou swimming between islands on numerous occasions.
...
Overall, there appears to be three groups of individuals: those that swim often
(n = 3, every ~`r indMean` days), those that swim occasionally (n = 9, every ~
`r ind2Mean` days), and those that never swam (n = 17). We are also unable to draw
conclusions about the prevalence of swimming in the ocean by male caribou: our
initial visual observation was of an adult male, but our GPS data only included adult
females.
...
(ref:fig1) Image of swimming unmarked adult male caribou (*Rangifer tarandus*) from Western to Eastern Indian Island taken on 30 May 2017.

```{r, fig.cap = '(ref:fig1)', fig.width=4.5}
knitr::include_graphics('../graphics/IMG_1562_crop.JPG')
```

\newpage

(ref:fig2) A) Map of the Fogo Island archipelago with swimming events between islands. B) Histogram displaying the distribution of swimming events throughout the year. Note, colours correspond to individual caribou. C) Inset of swimming events between small islands on the northern coast of Fogo island. D) Inset of swimming events between islands on the southern coast of Fogo island.
