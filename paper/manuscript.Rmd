...
observations, residents of Fogo Island have also reported regularly observing
...
in our study area and we are unable to determine the exact timing or duration of
sea ice from past years. However, we qualitatively delineate the timing of
typical sea ice arrival and departure (Figure 2B) and deduce that although the
majority of inter-island movements occur between April 1 and December 31, some
inter-island movements appear to be caribou walking on sea ice between islands.
Future research should focus on the trade-off between these types of movement.
...
younger caribou more likely to swim due to heightened competition? Are males or
females without a calf-at-heel more likely to swim in the summer given the are
not restricted based on presence of a calf-at-heel, as females are.
