...
Canada). Using `r substr(version$version.string, 1, 15)` [@R], we identified swimming events as two consecutive GPS locations (2-hour
...
`r ind2Mean` days), and those that never swam (n = 17). It is therefore possible that individuals vary in their tendency to swim. We are also unable to draw
