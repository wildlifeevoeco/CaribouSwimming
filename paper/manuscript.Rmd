...
behaviour was common among GPS radio-collared caribou in the population (n = 29, for collaring details see [@Peignier_2019]). Using `r substr(version$version.string, 1, 15)` [@R], we identified
