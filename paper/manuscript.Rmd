...
events, suggesting that for ~10% of collared individuals swim relatively
frequently, on average occurring approximately every `r indMean` days during
...
whether swimming is rare, and thus undetected, for the majority of individuals Overall, there appears to be three
