...
individuals: those that swam regularly between islands (n = 3, every ~`r indMean days`); those that rarely engaged in swimming events (n = 9, every ~ `r ind2Mean days`); and those that never swam (n = 17).
