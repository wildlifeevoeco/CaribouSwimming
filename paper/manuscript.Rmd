...
per year and remained on each island for approximately `r dur` (range = `r
durMin`-`r durMax`) days before swimming again. Based on GPS data to infer
...
mainly concerning predator avoidance or to access new habitats. We propose
